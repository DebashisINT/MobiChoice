package com.mobichoicebreeze.features.dashboard.presentation
...
import com.mobichoicebreeze.*
import com.mobichoicebreeze.R
import com.mobichoicebreeze.app.*
import com.mobichoicebreeze.app.NewFileUtils.browseDocuments
import com.mobichoicebreeze.app.NewFileUtils.browsePDFDocuments
import com.mobichoicebreeze.app.NewFileUtils.getExtension
import com.mobichoicebreeze.app.domain.*
import com.mobichoicebreeze.app.types.DashboardType
import com.mobichoicebreeze.app.types.FragType
import com.mobichoicebreeze.app.types.TopBarConfig
import com.mobichoicebreeze.app.uiaction.DisplayAlert
import com.mobichoicebreeze.app.utils.*
import com.mobichoicebreeze.app.utils.AppUtils.Companion.isProfile
import com.mobichoicebreeze.base.BaseResponse
import com.mobichoicebreeze.base.presentation.BaseActivity
import com.mobichoicebreeze.base.presentation.BaseFragment
import com.mobichoicebreeze.features.NewQuotation.*
import com.mobichoicebreeze.features.NewQuotation.api.GetQuotRegProvider
import com.mobichoicebreeze.features.NewQuotation.model.ViewDetailsQuotResponse
import com.mobichoicebreeze.features.SearchLocation.SearchLocationFragment
import com.mobichoicebreeze.features.SearchLocation.locationInfoModel
import com.mobichoicebreeze.features.TA.ViewAllTAListFragment
import com.mobichoicebreeze.features.achievement.AchievementFragment
import com.mobichoicebreeze.features.activities.presentation.*
import com.mobichoicebreeze.features.addAttendence.*
import com.mobichoicebreeze.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.mobichoicebreeze.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.mobichoicebreeze.features.addAttendence.model.GetReportToFCMResponse
import com.mobichoicebreeze.features.addAttendence.model.GetReportToResponse
import com.mobichoicebreeze.features.addAttendence.model.Leave_list_Response
import com.mobichoicebreeze.features.addorder.presentation.AddOrderFragment
...
import com.mobichoicebreeze.features.addshop.presentation.AddShopFragment
import com.mobichoicebreeze.features.addshop.presentation.OTPVerificationDialog
import com.mobichoicebreeze.features.addshop.presentation.ScanImageFragment
import com.mobichoicebreeze.features.addshop.presentation.ShowCardDetailsDialog
import com.mobichoicebreeze.features.alarm.model.AlarmData
import com.mobichoicebreeze.features.alarm.presetation.AttendanceReportFragment
import com.mobichoicebreeze.features.alarm.presetation.PerformanceReportFragment
import com.mobichoicebreeze.features.alarm.presetation.VisitReportDetailsFragment
import com.mobichoicebreeze.features.alarm.presetation.VisitReportFragment
import com.mobichoicebreeze.features.attendance.AttendanceFragment
import com.mobichoicebreeze.features.attendance.api.AttendanceRepositoryProvider
import com.mobichoicebreeze.features.attendance.model.AttendanceRequest
import com.mobichoicebreeze.features.attendance.model.AttendanceResponse
import com.mobichoicebreeze.features.averageshop.presentation.AverageShopFragment
import com.mobichoicebreeze.features.avgorder.presentation.AverageOrderFragment
import com.mobichoicebreeze.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.mobichoicebreeze.features.beatCustom.TeamBeatListFragment
import com.mobichoicebreeze.features.billing.presentation.AddBillingFragment
import com.mobichoicebreeze.features.billing.presentation.BillingDetailsFragment
import com.mobichoicebreeze.features.billing.presentation.BillingListFragment
import com.mobichoicebreeze.features.changepassword.presentation.ChangePasswordDialog
import com.mobichoicebreeze.features.chat.model.ChatListDataModel
import com.mobichoicebreeze.features.chat.model.ChatUserDataModel
import com.mobichoicebreeze.features.chat.model.GroupUserDataModel
import com.mobichoicebreeze.features.chat.presentation.*
import com.mobichoicebreeze.features.chatbot.presentation.ChatBotFragment
import com.mobichoicebreeze.features.chatbot.presentation.ChatBotShopListFragment
import com.mobichoicebreeze.features.chatbot.presentation.ReportsFragment
import com.mobichoicebreeze.features.chatbot.presentation.SelectLanguageDialog
import com.mobichoicebreeze.features.commondialog.presentation.CommonDialog
import com.mobichoicebreeze.features.commondialog.presentation.CommonDialogClickListener
import com.mobichoicebreeze.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.mobichoicebreeze.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.mobichoicebreeze.features.commondialogsinglebtn.OnDialogClickListener
import com.mobichoicebreeze.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.mobichoicebreeze.features.contacts.ActivityDtlsFrag
import com.mobichoicebreeze.features.contacts.AddOpptFrag
import com.mobichoicebreeze.features.contacts.ContactDtls
import com.mobichoicebreeze.features.contacts.ContactGr
import com.mobichoicebreeze.features.contacts.ContactsAddFrag
import com.mobichoicebreeze.features.contacts.ContactsFrag
import com.mobichoicebreeze.features.contacts.SchedulerViewFrag
import com.mobichoicebreeze.features.contacts.SchedulerAddFormFrag
import com.mobichoicebreeze.features.contacts.TemplateAddFrag
import com.mobichoicebreeze.features.contacts.TemplateViewFrag
import com.mobichoicebreeze.features.contacts.ViewCrmOpptFrag
import com.mobichoicebreeze.features.dailyPlan.prsentation.AllShopListFragment
import com.mobichoicebreeze.features.dailyPlan.prsentation.DailyPlanListFragment
import com.mobichoicebreeze.features.dailyPlan.prsentation.PlanDetailsFragment
import com.mobichoicebreeze.features.damageProduct.ShopDamageProductListFrag
import com.mobichoicebreeze.features.damageProduct.ShopDamageProductSubmitFrag
import com.mobichoicebreeze.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.mobichoicebreeze.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.mobichoicebreeze.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.mobichoicebreeze.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.mobichoicebreeze.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.mobichoicebreeze.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.mobichoicebreeze.features.dashboard.presentation.model.ContentListResponseModel
import com.mobichoicebreeze.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.mobichoicebreeze.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.mobichoicebreeze.features.device_info.presentation.DeviceInfoListFragment
import com.mobichoicebreeze.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.mobichoicebreeze.features.document.DocumentRepoFeatureNewFragment
import com.mobichoicebreeze.features.document.presentation.DocumentListFragment
import com.mobichoicebreeze.features.document.presentation.DocumentTypeListFragment
import com.mobichoicebreeze.features.document.presentation.OpenFileWebViewFragment
import com.mobichoicebreeze.features.dymanicSection.presentation.AddDynamicFragment
import com.mobichoicebreeze.features.dymanicSection.presentation.AllDynamicListFragment
import com.mobichoicebreeze.features.dymanicSection.presentation.DynamicListFragment
import com.mobichoicebreeze.features.dymanicSection.presentation.EditDynamicFragment
import com.mobichoicebreeze.features.gpsDisabilityScreen.GpsDisableFragment
import com.mobichoicebreeze.features.home.presentation.HomeFragment
import com.mobichoicebreeze.features.homelocation.presentation.HomeLocationFragment
import com.mobichoicebreeze.features.homelocation.presentation.HomeLocationMapFragment
import com.mobichoicebreeze.features.know_your_state.KnowYourStateFragment
import com.mobichoicebreeze.features.lead.LeadFrag
import com.mobichoicebreeze.features.lead.ViewLeadFrag
import com.mobichoicebreeze.features.leaderboard.LeaderBoardFrag
import com.mobichoicebreeze.features.leaveapplynew.LeaveHome
import com.mobichoicebreeze.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.mobichoicebreeze.features.localshops.LocalShopListFragment
import com.mobichoicebreeze.features.localshops.LocalShopListMapFragment
import com.mobichoicebreeze.features.localshops.NearByShopsMapFragment
import com.mobichoicebreeze.features.location.*
import com.mobichoicebreeze.features.location.api.LocationRepoProvider
import com.mobichoicebreeze.features.location.model.*
import com.mobichoicebreeze.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.mobichoicebreeze.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.mobichoicebreeze.features.login.ShopFeedbackEntity
import com.mobichoicebreeze.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.mobichoicebreeze.features.login.presentation.LoginActivity
import com.mobichoicebreeze.features.logout.presentation.api.LogoutRepositoryProvider
import com.mobichoicebreeze.features.logoutsync.presentation.LogoutSyncFragment
import com.mobichoicebreeze.features.marketAssist.MarketAssistTabFrag
import com.mobichoicebreeze.features.marketAssist.ShopDtlsMarketAssistFrag
import com.mobichoicebreeze.features.marketAssist.ShopListMarketAssistFrag
import com.mobichoicebreeze.features.marketing.presentation.MarketingPagerFragment
import com.mobichoicebreeze.features.meetinglist.prsentation.MeetingListFragment
import com.mobichoicebreeze.features.member.MapViewForTeamFrag
import com.mobichoicebreeze.features.member.model.TeamLocDataModel
import com.mobichoicebreeze.features.member.model.TeamShopListDataModel
import com.mobichoicebreeze.features.member.presentation.*
import com.mobichoicebreeze.features.menuBeat.MenuBeatFrag
import com.mobichoicebreeze.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.mobichoicebreeze.features.micro_learning.presentation.MicroLearningListFragment
import com.mobichoicebreeze.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.mobichoicebreeze.features.myallowancerequest.MyallowanceRequestFragment
import com.mobichoicebreeze.features.myjobs.model.CustomerDataModel
import com.mobichoicebreeze.features.myjobs.presentation.*
import com.mobichoicebreeze.features.mylearning.MyLearningFragment
import com.mobichoicebreeze.features.myorder.presentation.MyOrderListFragment
import com.mobichoicebreeze.features.myprofile.presentation.MyProfileFragment
import com.mobichoicebreeze.features.nearbyshops.api.ShopListRepositoryProvider
import com.mobichoicebreeze.features.nearbyshops.model.ShopData
import com.mobichoicebreeze.features.nearbyshops.model.ShopListResponse
import com.mobichoicebreeze.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.mobichoicebreeze.features.nearbyshops.presentation.BeatListFragment
import com.mobichoicebreeze.features.nearbyshops.presentation.NearByShopsListFragment
import com.mobichoicebreeze.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.mobichoicebreeze.features.nearbyshops.presentation.ShopCallHisFrag
import com.mobichoicebreeze.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.mobichoicebreeze.features.newcollection.CollectionDetailsStatusFragment
import com.mobichoicebreeze.features.newcollection.CollectionShopListFragment
import com.mobichoicebreeze.features.newcollection.NewCollectionListFragment
import com.mobichoicebreeze.features.newcollectionreport.*
import com.mobichoicebreeze.features.notification.NotificationFragment
import com.mobichoicebreeze.features.orderITC.CartListFrag
import com.mobichoicebreeze.features.orderITC.OrderListFrag
import com.mobichoicebreeze.features.orderITC.ProductListFrag
import com.mobichoicebreeze.features.orderITC.ViewNewOrdHisAllFrag
import com.mobichoicebreeze.features.orderITC.ViewNewOrdHistoryFrag
import com.mobichoicebreeze.features.orderITC.ViewOrdDtls
import com.mobichoicebreeze.features.orderList.NewDateWiseOrderListFragment
import com.mobichoicebreeze.features.orderList.NewOrderListFragment
import com.mobichoicebreeze.features.orderList.OrderListFragment
import com.mobichoicebreeze.features.orderdetail.presentation.OrderDetailFragment
import com.mobichoicebreeze.features.orderhistory.ActivityMapFragment
import com.mobichoicebreeze.features.orderhistory.OrderhistoryFragment
import com.mobichoicebreeze.features.orderhistory.TimeLineFragment
import com.mobichoicebreeze.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.mobichoicebreeze.features.orderhistory.model.LocationData
import com.mobichoicebreeze.features.pendinglocationinout.PendingOutLocationFrag
import com.mobichoicebreeze.features.performance.GpsStatusFragment
import com.mobichoicebreeze.features.performance.PerformanceFragment
import com.mobichoicebreeze.features.performance.api.UpdateGpsStatusRepoProvider
import com.mobichoicebreeze.features.performance.model.UpdateGpsInputParamsModel
import com.mobichoicebreeze.features.performanceAPP.OwnPerformanceFragment
import com.mobichoicebreeze.features.performanceAPP.PerformanceAppFragment
import com.mobichoicebreeze.features.performanceAPP.allPerformanceFrag
import com.mobichoicebreeze.features.permissionList.ViewPermissionFragment
import com.mobichoicebreeze.features.photoReg.*
import com.mobichoicebreeze.features.privacypolicy.PrivacypolicyWebviewFrag
import com.mobichoicebreeze.features.quotation.presentation.*
import com.mobichoicebreeze.features.reimbursement.presentation.*
import com.mobichoicebreeze.features.report.presentation.*
import com.mobichoicebreeze.features.returnsOrder.*
import com.mobichoicebreeze.features.settings.presentation.SettingsFragment
import com.mobichoicebreeze.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.mobichoicebreeze.features.shopdetail.presentation.*
import com.mobichoicebreeze.features.shopdetail.presentation.api.EditShopRepoProvider
import com.mobichoicebreeze.features.stock.StockDetailsFragment
import com.mobichoicebreeze.features.stock.StockListFragment
import com.mobichoicebreeze.features.stockAddCurrentStock.AddShopStockFragment
import com.mobichoicebreeze.features.stockAddCurrentStock.UpdateShopStockFragment
import com.mobichoicebreeze.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.mobichoicebreeze.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.mobichoicebreeze.features.stockCompetetorStock.AddCompetetorStockFragment
import com.mobichoicebreeze.features.stockCompetetorStock.CompetetorStockFragment
import com.mobichoicebreeze.features.stockCompetetorStock.ViewComStockProductDetails
import com.mobichoicebreeze.features.survey.SurveyFrag
import com.mobichoicebreeze.features.survey.SurveyViewDtlsFrag
import com.mobichoicebreeze.features.survey.SurveyViewFrag
import com.mobichoicebreeze.features.task.presentation.AddTaskFragment
import com.mobichoicebreeze.features.task.presentation.CalenderTaskFragment
import com.mobichoicebreeze.features.task.presentation.EditTaskFragment
import com.mobichoicebreeze.features.task.presentation.TaskListFragment
import com.mobichoicebreeze.features.taskManagement.TaskManagementFrag
import com.mobichoicebreeze.features.taskManagement.ViewTaskManagementFrag
import com.mobichoicebreeze.features.timesheet.presentation.AddTimeSheetFragment
import com.mobichoicebreeze.features.timesheet.presentation.EditTimeSheetFragment
import com.mobichoicebreeze.features.timesheet.presentation.TimeSheetListFragment
import com.mobichoicebreeze.features.viewAllOrder.CartFragment
import com.mobichoicebreeze.features.viewAllOrder.OrderTypeListFragment
import com.mobichoicebreeze.features.viewAllOrder.ViewAllOrderListFragment
import com.mobichoicebreeze.features.viewAllOrder.ViewCartFragment
import com.mobichoicebreeze.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.mobichoicebreeze.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.mobichoicebreeze.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.mobichoicebreeze.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.mobichoicebreeze.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.mobichoicebreeze.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.mobichoicebreeze.features.viewPPDDStock.ViewOutstandingFragment
import com.mobichoicebreeze.features.viewPPDDStock.ViewPPDDListFragment
import com.mobichoicebreeze.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.mobichoicebreeze.features.viewPPDDStock.ViewStockFragment
import com.mobichoicebreeze.features.weather.presentation.WeatherFragment
import com.mobichoicebreeze.mappackage.MapActivity
import com.mobichoicebreeze.mappackage.MapActivityWithoutPath
import com.mobichoicebreeze.mappackage.SendBrod
import com.mobichoicebreeze.widgets.AppCustomEditText
import com.mobichoicebreeze.widgets.AppCustomTextView
...
import com.mobichoicebreeze.features.mylearning.SearchLmsFrag
import com.mobichoicebreeze.features.mylearning.VideoPlayLMS
    ...
    fun batteryCheck(mFragType: FragType, addToStack: Boolean, initializeObject: Any){
        ...
        try{
            ...
            if(!mFragType.equals(FragType.DashboardFragment) && sett==false && !mFragType.equals(FragType.LogoutSyncFragment)){
                ...
                if (mFragType ==FragType.MyLearningFragment || mFragType ==FragType.SearchLmsFrag || mFragType ==FragType.VideoPlayLMS) {
...
//                Toast.makeText(this@DashboardActivity, newText, Toast.LENGTH_SHORT).show()
    ...
    fun setNewMenu(){
        ...
        menuItems.add(MenuItems("My Learning",R.drawable.ic_learning_adv))
        ...
        adapterMenuAdv = AdapterMenuAdv(this,menuItems,menuSubItemsL,object : AdapterMenuAdv.OnClick{
            override fun onClick(obj: MenuItems) {
                ...
                if(obj.name.equals("Leaderboard",ignoreCase = true)){
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xmobichoicebreezelogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmobichoicebreezelogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.mobichoicebreeze/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmobichoicebreezelogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmobichoicebreezelogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmobichoicebreezelogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmobichoicebreezelogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
