package com.mobichoicebreeze.features.logoutsync.presentation
...
import com.mobichoicebreeze.CustomConstants


import com.mobichoicebreeze.R
import com.mobichoicebreeze.app.AppDatabase
import com.mobichoicebreeze.app.NetworkConstant
...
import com.mobichoicebreeze.app.utils.Toaster
import com.mobichoicebreeze.base.BaseResponse
import com.mobichoicebreeze.base.presentation.BaseActivity
import com.mobichoicebreeze.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.mobichoicebreeze.features.billing.api.AddBillingRepoProvider
import com.mobichoicebreeze.features.billing.model.AddBillingInputParamsModel
...
import com.mobichoicebreeze.features.dashboard.presentation.ReasonDialog
...
import com.mobichoicebreeze.features.document.model.AddEditDocumentInputParams
import com.mobichoicebreeze.features.document.model.DocumentAttachmentModel
...
import com.mobichoicebreeze.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.mobichoicebreeze.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.mobichoicebreeze.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.mobichoicebreeze.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.mobichoicebreeze.features.orderhistory.model.*
...
import com.mobichoicebreeze.features.quotation.model.AddQuotInputModel
import com.mobichoicebreeze.features.shopdetail.presentation.api.EditShopRepoProvider
import com.mobichoicebreeze.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.mobichoicebreeze.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
import com.mobichoicebreeze.features.stock.api.StockRepositoryProvider
import com.mobichoicebreeze.features.stock.model.AddStockInputParamsModel
import com.mobichoicebreeze.features.stockAddCurrentStock.AddShopStockFragment
import com.mobichoicebreeze.features.stockAddCurrentStock.ShopAddCurrentStockList
import com.mobichoicebreeze.features.stockAddCurrentStock.ShopAddCurrentStockRequest
import com.mobichoicebreeze.features.stockAddCurrentStock.api.ShopAddStockProvider
import com.mobichoicebreeze.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.mobichoicebreeze.features.timesheet.model.AddTimeSheetInputModel
import com.mobichoicebreeze.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.mobichoicebreeze.features.viewAllOrder.model.AddOrderInputParamsModel
import com.mobichoicebreeze.features.viewAllOrder.model.AddOrderInputProductList
import com.mobichoicebreeze.mappackage.SendBrod
import com.mobichoicebreeze.widgets.AppCustomTextView
import com.mobichoicebreeze.MonitorService
import com.mobichoicebreeze.MySingleton
import com.mobichoicebreeze.features.addshop.model.*
import com.mobichoicebreeze.features.addshop.model.assigntopplist.AddShopUploadImg
import com.mobichoicebreeze.features.addshop.presentation.ShopExtraContactReq
import com.mobichoicebreeze.features.addshop.presentation.multiContactRequestData
...
import com.mobichoicebreeze.features.login.model.GetConcurrentUserResponse
...
import com.mobichoicebreeze.features.orderITC.SyncDeleteOpptL
import com.mobichoicebreeze.features.orderITC.SyncEditOppt
import com.mobichoicebreeze.features.orderITC.SyncOppt
import com.mobichoicebreeze.features.orderITC.SyncOpptProductL
import com.mobichoicebreeze.features.orderITC.SyncOrd
import com.mobichoicebreeze.features.orderITC.SyncOrdProductL
import com.mobichoicebreeze.features.performance.model.Gps_status_list
import com.mobichoicebreeze.features.performance.model.UpdateGpsInputListParamsModel
import com.mobichoicebreeze.features.returnsOrder.ReturnProductList
import com.mobichoicebreeze.features.returnsOrder.ReturnRequest
import com.mobichoicebreeze.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmobichoicebreezelogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmobichoicebreezelogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmobichoicebreezelogsample/log.zip").path);
