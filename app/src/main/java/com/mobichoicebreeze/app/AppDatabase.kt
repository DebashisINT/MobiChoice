package com.mobichoicebreeze.app
...
import com.mobichoicebreeze.app.AppConstant.DBNAME
import com.mobichoicebreeze.app.domain.*
import com.mobichoicebreeze.features.lead.model.LeadActivityDao
import com.mobichoicebreeze.features.lead.model.LeadActivityEntity
import com.mobichoicebreeze.features.location.UserLocationDataDao
import com.mobichoicebreeze.features.location.UserLocationDataEntity
import com.mobichoicebreeze.features.login.*
import com.mobichoicebreeze.features.taskManagement.model.TaskManagementDao
...
@Database(entities = arrayOf(AddShopDBModelEntity::class, UserLocationDataEntity::class, UserLoginDataEntity::class, ShopActivityEntity::class,
    ...
    NewProductListEntity::class, NewRateListEntity::class, NewOrderDataEntity::class,NewOrderProductDataEntity::class,OpportunityStatusEntity::class,OpportunityAddEntity::class,OpportunityProductEntity::class),
